...
dataAll = read.csv("sims_0002_02_350_0.csv", header = TRUE)
...
write.csv(data_for_model, 'sims_0002_02_350_0_hddm.csv', row.names = FALSE)


# Linear, 10 subjects 

dataAll = read.csv("sims_linear_10subs_params.csv", header = TRUE)
...
write.csv(data_for_model, 'sims_linear_10subs_hddm.csv', row.names = FALSE)
